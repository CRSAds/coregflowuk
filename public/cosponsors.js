...
(function () {
  console.log("🤝 cosponsors-loader started (UK)");
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const popupHTML = `
      <div id="cosponsor-popup" class="cosponsor-popup" style="display:none;">
        ...
        <div class="cosponsor-content" role="dialog" aria-modal="true">
          ...
          <h2>Our Partners</h2>
          <div id="cosponsor-list">Loading...</div>
        </div>
      </div>
    `;
    ...
    // =========================
    // CSS (Identiek aan NL, geïsoleerd)
    // =========================
    ...
    async function loadSponsors() {
      ...
      try {
        ...
        json.data.forEach(s => {
          ...
          item.innerHTML = `
            ...
            <div>
              ...
              <a href="${s.privacy_url}" target="_blank" rel="noopener">Privacy Policy</a>
            </div>
          `;
        ...
        list.innerHTML = "<p>Something went wrong loading the partner list.</p>";
      }
    }
